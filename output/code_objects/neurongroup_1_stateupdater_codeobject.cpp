...
{	
	...
	///// CONSTANTS ///////////
	const int _numlastspike = 16;
const int _numge = 16;
const int _numt = 1;
const int _numv = 16;
const int _numdt = 1;
const int _numgi = 16;
const int _numnot_refractory = 16;
	///// POINTERS ////////////
 	
 double* __restrict  _ptr_array_neurongroup_1_lastspike = _array_neurongroup_1_lastspike;
 double* __restrict  _ptr_array_neurongroup_1_ge = _array_neurongroup_1_ge;
 double*   _ptr_array_defaultclock_t = _array_defaultclock_t;
 double* __restrict  _ptr_array_neurongroup_1_v = _array_neurongroup_1_v;
 double*   _ptr_array_defaultclock_dt = _array_defaultclock_dt;
 double* __restrict  _ptr_array_neurongroup_1_gi = _array_neurongroup_1_gi;
 bool* __restrict  _ptr_array_neurongroup_1_not_refractory = _array_neurongroup_1_not_refractory;
 ...
 const double _lio_1 = (- dt) / 0.001;
 const double _lio_2 = dt / 0.01;
 const double _lio_3 = (- dt) / 0.002;
