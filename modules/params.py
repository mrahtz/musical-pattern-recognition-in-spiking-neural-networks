...
def get_params():
    ...
    parser.add_argument('--tc_theta', type=float, default=1e6)
    parser.add_argument('--nu_ee_pre', type=float, default=0.0001)
    parser.add_argument('--nu_ee_post', type=float, default=0.04)
    ...
    parser.add_argument('--load_weights', type=argparse.FileType('rb'))
    parser.add_argument('--load_theta', type=argparse.FileType('rb'))
...
def neuron_params_from_args(args):
    ...
    neuron_params['tc_theta'] = args.tc_theta * b2.ms
    ...
    neuron_params['theta_file'] = args.load_theta
...
def connection_params_from_args(args):
    ...
    connection_params['save_weights'] = args.save_weights
    connection_params['weight_file'] = args.load_weights
...
def analysis_params_from_args(args):
    analysis_params = {}
    analysis_params['classify'] = args.classify
